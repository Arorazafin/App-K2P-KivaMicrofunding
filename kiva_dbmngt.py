...
class DBKiva(object):
    ...
    def run_importTableFromFile(self, filename, user, pw, db='kiva', host='localhost',
                     port='5432'):
        '''
...
if __name__ == '__main__':
    ...
    ex: dbkiva_mngt.py filename json username password
    python kiva_dbmngt.py lenders.json postgres aro
    '''
    
    dbkiva = DBKiva()
    dbkiva.run_importTableFromFile(*sys.argv[1:])
